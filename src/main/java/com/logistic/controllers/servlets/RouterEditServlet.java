...
import com.logistic.model.systemunits.entities.validationgroups.RouterAddGroup;
...
public class RouterEditServlet extends AbstractHttpServlet {
    ...
    public RouterEditServlet() {
        logger = LoggerFactory.getLogger("com.logistic.controllers.servlets.RouterEditServlet");
    }
