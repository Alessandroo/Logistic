...
import com.logistic.dao.interfaces.CitiesOfCountry;
...
public class SuggestionServlet extends HttpServlet {
    ...
    public SuggestionServlet() {
        ...
        logger = LoggerFactory.getLogger("com.logistic.controllers.servlets.SuggestionServlet");
    }
        ...
        switch (field) {
            ...
            case "router" : {
                try {
                    ...
                    Logger logger = LoggerFactory.getLogger("com.logistic.controllers.servlets.SuggestionServlet");
                    logger.warn("Cannot read suggestions", e);
                } catch (Exception e) {
                    Logger logger = LoggerFactory.getLogger("com.logistic.controllers.servlets.SuggestionServlet");
                    logger.warn("Exception", e);
